const ProductCell = ({ product }) => {
    ...
    return (
        <div className="flex rounded-md shadow-[0px_2px_2px_2px_rgba(0,0,0,0.25)] justify-between flex-col bg-[#6B3710] hover:bg-[#3E1900] p-2 flex-wrap  text-[#FFC376]">
            ...
            <img src={product.product_img || '../../images/default.png'} alt={product.product_name} className={`  sm:w-24 sm:h-24 ${product.product_img===null?'rounded-full':'rounded-full border-[0.25rem] border-[#D87B26]'}  bg-[#3E1900]   m-auto object-fill `} />
            </div>
