...
y
        ...
        <div className='col-span-2 flex flex-col  h-[100%] px-2 py-2  flex justify-center border-4   border-[rgb(180,81,5)] outline outline-4 outline-[rgb(107,55,16)] bg-[#FFC376]'>
          <h1 className='poppins-semibold'></h1>
          
          <Mainchart />
        </div>

        <div className='h-[100%] col-span-1 px-2 py-2 flex flex-col items-center self-center w-[100%] border-4   border-[rgb(180,81,5)] outline outline-4 outline-[rgb(107,55,16)] bg-[#FFC376]'>
